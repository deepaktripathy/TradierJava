...
import com.tradierapi.tradierjava.model.OrderStatus;
import com.tradierapi.tradierjava.model.OrderType;
import com.tradierapi.tradierjava.model.Side;
...
public class Order {
	...
	public String toString() {
		return "Order [id=" + id + ", orderType=" + orderType + ", symbol=" + symbol + ", side=" + side + ", quantity="
				...
				+ ", createDate=" + createDate + ", transactionDate=" + transactionDate + ", orderClass=" + orderClass
				+ ", orderStrategy=" + orderStrategy + ", optionSymbol=" + optionSymbol + ", stopPrice=" + stopPrice
				+ ", reasonDescription=" + reasonDescription + ", orderTag=" + orderTag + "]";
	}
