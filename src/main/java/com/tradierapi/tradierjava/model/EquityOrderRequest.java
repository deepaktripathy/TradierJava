...
public class EquityOrderRequest extends OrderRequest {
    ...
    public static EquityOrderRequest buildMarketOrder(EquitySide side, String symbol, 
    		Double quantity, OrderType orderType, Duration duration, Double stopPrice, 
    		String orderTag) {
    	return buildLimitOrder(side, symbol, quantity,
        		null, orderType, duration, stopPrice, orderTag);
    }
    
    public static EquityOrderRequest buildLimitOrder(EquitySide side, String symbol, 
    		Double quantity, Double price, 
    		OrderType orderType, Duration duration, Double stopPrice, String orderTag) {
    	
    	EquityOrderRequest request = new EquityOrderRequest(side, symbol, quantity, price, 
    			orderType, duration, stopPrice, orderTag);
    ...
    public EquityOrderRequest(EquitySide side, String symbol, Double quantity, Double price,
    		OrderType orderType, Duration duration, Double stopPrice, String orderTag) {
