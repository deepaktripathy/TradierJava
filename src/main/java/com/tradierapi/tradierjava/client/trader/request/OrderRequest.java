...
public abstract class OrderRequest {
   ...
   public String toString() {
      return "OrderRequest [orderType=" + orderType + ", symbol=" + symbol + ", quantity=" + quantity + ", duration="
            + duration + ", price=" + price + ", createDate=" + createDate + ", equityClass=" + equityClass
            + ", stopPrice=" + stopPrice + ", orderTag=" + orderTag + "]";
   }
