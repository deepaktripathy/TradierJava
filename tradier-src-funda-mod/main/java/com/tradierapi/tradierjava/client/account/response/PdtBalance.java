...
/**
 * This is part of Balances and is populated if the account_type is marked as
 * PDT.
 *
 * @author deepak
 *
...
public class PdtBalance extends UnrecognizedFieldsCollector {
   ...
   public int hashCode() {
      ...
      result = prime * result
            + Objects.hash(fedCall, maintenanceCall, optionBuyingPower, stockBuyingPower, stockShortValue);
      return result;
   }
